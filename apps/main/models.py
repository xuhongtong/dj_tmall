...
class UserProfile(models.Model):
    ...
    icon = models.ImageField(verbose_name=u'头像', max_length=100, upload_to='upload/img/%Y%m%d',default='media/image/1.jpg')
...
class ShopImage(models.Model):
    shop_img_id = models.AutoField(primary_key=True,verbose_name='ID')
    shop = models.ForeignKey(Shop, models.DO_NOTHING, db_column='shop_id', db_index=True, verbose_name='商品ID')
